...
`,Jn={root:"p-card p-component",header:"p-card-header",body:"p-card-body",caption:"p-card-caption",title:"p-card-title",subtitle:"p-card-subtitle",content:"p-card-content",footer:"p-card-footer"},Xn=w.extend({name:"card",style:Zn,classes:Jn}),qn={name:"BaseCard",extends:Y,style:Xn,provide:function(){return{$pcCard:this,$parentInstance:this}}},Qn={name:"Card",extends:qn,inheritAttrs:!1};function nt(n,t,e,o,r,i){return x(),C("div",_({class:n.cx("root")},n.ptmi("root")),[n.$slots.header?(x(),C("div",_({key:0,class:n.cx("header")},n.ptm("header")),[A(n.$slots,"header")],16)):B("",!0),nn("div",_({class:n.cx("body")},n.ptm("body")),[n.$slots.title||n.$slots.subtitle?(x(),C("div",_({key:0,class:n.cx("caption")},n.ptm("caption")),[n.$slots.title?(x(),C("div",_({key:0,class:n.cx("title")},n.ptm("title")),[A(n.$slots,"title")],16)):B("",!0),n.$slots.subtitle?(x(),C("div",_({key:1,class:n.cx("subtitle")},n.ptm("subtitle")),[A(n.$slots,"subtitle")],16)):B("",!0)],16)):B("",!0),nn("div",_({class:n.cx("content")},n.ptm("content")),[A(n.$slots,"content")],16),n.$slots.footer?(x(),C("div",_({key:1,class:n.cx("footer")},n.ptm("footer")),[A(n.$slots,"footer")],16)):B("",!0)],16)],16)}Qn.render=nt;var tt=`
.p-icon {
